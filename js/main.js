...
function changeCard(item) {
  jquery__WEBPACK_IMPORTED_MODULE_3___default()(item).each(function (i) {
    jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).on("click", function (e) {
      e.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(".program-info").eq(i).toggleClass("program-info_active");
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(".program-list").eq(i).toggleClass("program-list_active");
    });
  });
}

changeCard(".program-info__button");
changeCard(".program-list__button"); // POST

jquery__WEBPACK_IMPORTED_MODULE_3___default()("#form").on("submit", function (e) {
  var _document, _document2, _document3;

  e.preventDefault();
  var TOKEN = "5369957968:AAHrLt-fNVbjC9J3B_whNH4lcVopmemnl58";
  var CHAT_ID = "-1001576354120";
  var URI_API = "https://api.telegram.org/bot".concat(TOKEN, "/sendMessage");
  var success = document.querySelector(".success"),
      failure = document.querySelector(".failure");
  var name = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector("#input-name"),
      phone = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelector("#input-phone"),
      tgName = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector("#input-tg-name");
  var message = "\n  <b>\u0424\u0418: ".concat(name.value, "</b>\n  <b>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430: ").concat(phone.value, "</b>\n  <b>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430: @").concat(tgName.value, "</b>"); // TODO: Вставить нужный url для отправки

  var request = jquery__WEBPACK_IMPORTED_MODULE_3___default().ajax(URI_API, {
    type: "POST",
    data: {
      chat_id: CHAT_ID,
      parse_mode: "html",
